from src.config.models.distributions import Distributions
...
class DistributionRepository:
    ...
    async def create_distribution_async(self, orm_model: Distributions):
    ...
    async def update_distribution_async(self, orm_model: Distributions):
